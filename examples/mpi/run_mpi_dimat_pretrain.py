"""
MPI run script for DIMAT with pre-training phase.

Matches the paper setup:
  1. Pre-train each agent independently for N epochs (default 100)
...
parser.add_argument(
    "--server_config",
    type=str,
    default="./resources/configs/cifar100/server_dimat_ring.yaml",
)
parser.add_argument(
    "--client_config",
    type=str,
    default="./resources/configs/cifar100/client_dimat_ring.yaml",
)
parser.add_argument(
    "--pretrain_epochs",
    type=int,
