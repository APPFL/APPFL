...
# mpiexec -np n+1 --mca opal_cuda_support 1 python ./cifar10_async_mpi.py --loss_fn losses/celoss.py --loss_fn_name CELoss
# To run MPI with n clients:
# mpiexec -np n+1 python ./cifar10_async_mpi.py --loss_fn losses/celoss.py --loss_fn_name CELoss
