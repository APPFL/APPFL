...
"""
python cifar10.py --clientname=ClientOptimPCA
"""
...
## pca
parser.add_argument("--pca_dir", type=str, default="./archive/CIFAR10_1client/client")
...
args.output_dirname = "./outputs_%s_%s_%s_%s_%s_%s_%s" % (
        args.dataset,
        args.model,
        args.servername,
        args.clientname,
