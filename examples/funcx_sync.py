...
parser.add_argument(
    "--config", type=str, default="configs/fed_async/funcx_fed_async_mnist.yaml"
)
...
def main():
    ...
    ## config logger
    mLogging.config_logger(
        cfg, osp.basename(args.config), osp.basename(args.client_config), mode=mode
    )
