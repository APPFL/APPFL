"""
Run multiple gRPC clients to benchmark the server with compression.
"""
...
argparser.add_argument(
    "--client_config", 
    type=str, 
    default="configs/compression/client_grpc.yaml",
...
while True:
    ...
    client_agent.logger.info(f"The length of model is {len(local_model)}")
