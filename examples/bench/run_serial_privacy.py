...
argparser.add_argument("--server_config", type=str, default="configs/privacy/tcga_server.yaml")
argparser.add_argument("--client_config", type=str, default="configs/privacy/tcga_client.yaml")
argparser.add_argument("--num_clients", type=int, default=5)
...
for i in range(args.num_clients):
    client_agent_configs[i].train_configs.logging_id = f'Client{i}'
...
while not server_agent.training_finished():
    ...
    server_val_acc.append(server_agent.server_validate()[1])
...
server_agent.logger.info(f"Server validation accuracy: {server_val_acc}")