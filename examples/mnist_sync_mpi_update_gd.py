...
def main():
    ...
    """ Running """
    if comm_rank == 0:
        rmn.run_server(cfg, comm, model, loss_fn, args.num_clients, test_dataset, args.dataset)
    else:
        assert comm_size == args.num_clients + 1
        rmn.run_client(cfg, comm, model, loss_fn, args.num_clients, train_datasets, test_dataset)
...
# mpiexec -np 7 python mnist_sync_mpi_update_gd.py --num_epochs 12
