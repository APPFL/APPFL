...
def get_timesfm(state_dict_path, lookback=512, lookahead=96):
  home_directory = os.environ.get("HOME")
  state_dict_path = os.path.join(home_directory, state_dict_path)

  model = TimesFM(lookback, lookahead)
  model.timesfm.load_state_dict(torch.load(state_dict_path, map_location='cpu'))
  return model