...
def partition_noiid(comm: MPI.Comm, cfg: DictConfig, dataset: str, seed: int = 42, visualization: bool = True):
    ...
    Cmin = {1: 10, 2: 7, 3: 6, 4: 5, 5: 5, 6: 4, 7: 4, 'none': 2}       # minimum sample classes for each client
    Cmax = {1: 10, 2: 8, 3: 8, 4: 7, 5: 6, 6: 6, 7: 5, 'none': 4}       # maximum sample classes for each client
