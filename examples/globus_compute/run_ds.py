...
argparser.add_argument(
    "--server_config",
    type=str,
    default="./resources/config_gc/c4/server_fedavg_proxystore_ds.yaml",
)
argparser.add_argument(
    "--client_config", type=str, default="./resources/config_gc/c4/clients_fedavg_proxystore_ds.yaml"
)
...
server_agent.set_sample_size("76aadeb8-2852-452e-ae73-a9408f3cfbd9", 256)   
