...
FL_FOLD="outputs_funcx_fedavg_covid_sgd_lr0.003_covid19_uchicago_eqprevalence_midrc"
FL_FOLD="outputs_funcx_fedavg_covid_sgd_freeze_bn_covid19_uchicago_v2_midrc_v2"
FL_CKPT="best"
