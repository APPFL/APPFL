...
if hasattr(client_agent_config, 'dr_metrics'):
    dr_agent = DRAgent(client_agent_config)
    readiness_report = dr_agent.generate_readiness_report()
    client_communicator.invoke_custom_action(action='data_readiness_report',**readiness_report)
