...
argparse.add_argument("--server_config", type=str, default="resources/configs/mnist/config_server.yaml")
argparse.add_argument("--client_config", type=str, default="resources/configs/mnist/config_client.yaml")
