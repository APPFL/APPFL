...
def model_parameters_norm(model, C, norm_type=1):
    """
    Compute the norm of all the parameters of a model and return that norm
    if it is below the threshold C, otherwise return C.
