...
class ServerFedAdagrad(FedServer):
    ...
    def logging_summary(self, cfg, logger):
        ...
        with open(cfg.logginginfo.summary_file, 'a') as f:
            ...
            f.write(cfg.logginginfo.DataSet_name + ' FedAdagrad ClientLR ' + str(cfg.fed.args.optim_args.lr) + ' MParam1 ' + str(cfg.fed.args.server_momentum_param_1) + ' AdaptParam ' + str(cfg.fed.args.server_adapt_param) + ' ServerLR ' + str(cfg.fed.args.server_learning_rate) + ' MParam2 ' + str(cfg.fed.args.server_momentum_param_2)  + ' TestAccuracy ' + str(cfg.logginginfo.accuracy) +' BestAccuracy ' + str(cfg.logginginfo.BestAccuracy) + '\n')  
