...
class GlobusComputeClientLLMFineTuneOptim(BaseClient):
    ...
    def __init__(self, id, weight, model, loss_fn, dataloader, cfg, outfile, test_dataloader, metric, global_epoch=0, send_gradient=False, **kwargs):
        super(GlobusComputeClientLLMFineTuneOptim, self).__init__(id, weight, model, loss_fn, dataloader, cfg, outfile, test_dataloader, metric)
        super(GlobusComputeClientLLMFineTuneOptim, self).client_log_title()
    ...
    def update(self, cli_logger):
        ...
        if self.cfg.validation == True and self.test_dataloader != None:
            ...
            super(GlobusComputeClientLLMFineTuneOptim, self).client_log_content(0, per_iter_time, 0, 0, test_loss, test_accuracy)   
        ...
        if self.use_dp:
            ...
            super(GlobusComputeClientLLMFineTuneOptim, self).laplace_mechanism_output_perturb(scale_value)
