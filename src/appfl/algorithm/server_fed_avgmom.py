    ...
    def logging_summary(self, cfg, logger):
        ...
        if cfg.summary_file != "":
            with open(cfg.summary_file, 'a') as f:
                ...
                f.write(cfg.logginginfo.DataSet_name + ' FedAvgM ClientLR ' + str(cfg.fed.args.optim_args.lr) + ' MParam1 ' + str(cfg.fed.args.server_momentum_param_1) + ' TestAccuracy ' + str(cfg.logginginfo.accuracy) +' BestAccuracy ' + str(cfg.logginginfo.BestAccuracy) + ' Time ' + str(round(cfg.logginginfo.Elapsed_time,2)) + '\n')  
