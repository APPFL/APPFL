...
class ClientOptimFlambyUpdate(BaseClient):
    def __init__(self, id, weight, model, loss_fn, dataloader, cfg, outfile, test_dataloader, metric, **kwargs):
        super(ClientOptimFlambyUpdate, self).__init__(id, weight, model, loss_fn, dataloader, cfg, outfile, test_dataloader)
        super(ClientOptimFlambyUpdate, self).client_log_title()
    ...
    def update(self):
        ...
        if self.cfg.validation == True and self.test_dataloader != None:
            ...
            super(ClientOptimFlambyUpdate, self).client_log_content(0, per_iter_time, 0, 0, test_loss, metric_res)
            self.model.train()
        ...
        if self.epsilon != False:
            ...
            super(ClientOptimFlambyUpdate, self).laplace_mechanism_output_perturb(scale_value)
