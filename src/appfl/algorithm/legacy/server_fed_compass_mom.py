...
class ServerFedCompassMom(FedServer):
    def __init__(self, weights, model, loss_fn, num_clients, device, **kwargs):
        ...
        super(ServerFedCompassMom, self).__init__(weights, model, loss_fn, num_clients, device, **kwargs)
        ...
        if cfg.summary_file != "":
            with open(cfg.summary_file, "a") as f:
                ...
                f.write(
                    ...
                    + " ServerFedCompassMom ClientLR "
                    + str(cfg.fed.args.optim_args.lr)
                    + " ServerFedCompassMom Alpha "
                    + str(cfg.fed.args.alpha)
                    + " ServerFedCompassMom Staleness Function"
