...
class ClientOptimPCA3(BaseClient):
    def __init__(
        self, id, weight, model, dataloader, cfg, outfile, test_dataloader, **kwargs
    ):
        super(ClientOptimPCA3, self).__init__(
        ...
        ## construct
        self.P, self.EVR = super(ClientOptimPCA3, self).construct_projection_matrix()
        super(ClientOptimPCA3, self).log_pca()
        super(ClientOptimPCA3, self).client_log_title()
    ...
    def update(self):
        ...
        for t in range(self.num_local_epochs):
            ...
            for data, target in self.dataloader:
                ...
                ## gradient
                grad = super(ClientOptimPCA3, self).get_model_grad_vec()
                ...
                super(ClientOptimPCA3, self).update_grad(grad_proj)                
        ...
        self.local_state["reduced_grad"] = reduced_grad     
