...
class DFLNodeAgent:
    ...
    def aggregate_parameters(
        self,
        neighbor_models: Union[Dict[str, Dict], List[Dict]],
        **kwargs
    ) -> None:
        """
    ...
    def _load_model(self) -> None:
        ...
        if not hasattr(self.dfl_node_agent_config, "model_configs"):
            ...
            return
        self._set_seed()
        if hasattr(self.dfl_node_agent_config.model_configs, "model_path") and hasattr(self.dfl_node_agent_config.model_configs, "model_name"):
        ...
        elif hasattr(self.dfl_node_agent_config.model_configs, "model_source") and hasattr(self.dfl_node_agent_config.model_configs, "model_name"):
            kwargs = self.dfl_node_agent_config.model_configs.get("model_kwargs", {})
    ...
    def _load_loss(self) -> None:
        ...
        if not hasattr(self.dfl_node_agent_config, "train_configs"):
            self.loss_fn = None
            return
        if hasattr(self.dfl_node_agent_config.train_configs, "loss_fn_path") and hasattr(self.dfl_node_agent_config.train_configs, "loss_fn_name"):
            ...
            if hasattr(torch.nn, self.dfl_node_agent_config.train_configs.loss_fn):                
                self.loss_fn = getattr(torch.nn, self.dfl_node_agent_config.train_configs.loss_fn)(**kwargs)
            else:
                self.loss_fn = None
        elif hasattr(self.dfl_node_agent_config.train_configs, "loss_fn_source") and hasattr(self.dfl_node_agent_config.train_configs, "loss_fn_name"):
            kwargs = self.dfl_node_agent_config.train_configs.get("loss_fn_kwargs", {})
    ...
    def _load_metric(self) -> None:
        ...
        if not hasattr(self.dfl_node_agent_config, "train_configs"):
            self.metric = None
            return
        if hasattr(self.dfl_node_agent_config.train_configs, "metric_path") and hasattr(self.dfl_node_agent_config.train_configs, "metric_name"):
        ...
        elif hasattr(self.dfl_node_agent_config.train_configs, "metric_source") and hasattr(self.dfl_node_agent_config.train_configs, "metric_name"):
        ...
        if hasattr(self.dfl_node_agent_config.data_configs, "dataset_source"):
            self.train_dataset, self.val_dataset = run_function_from_file_source(
                ...
                **(
                    ...
                    if hasattr(self.dfl_node_agent_config.data_configs, "dataset_kwargs") 
                    else {}
                )
            )
        else:
    ...
    def _load_trainer(self) -> None:
        ...
        if not hasattr(trainer_module, self.dfl_node_agent_config.train_configs.trainer):
            raise ValueError(f'Invalid trainer name: {self.dfl_node_agent_config.train_configs.trainer}')
        self.trainer: BaseTrainer = getattr(trainer_module, self.dfl_node_agent_config.train_configs.trainer)(
            model=self.model, 
    ...
    def _load_aggregator(self) -> None:
        self.aggregator: BaseAggregator = eval(self.dfl_node_agent_config.aggregator)(
            self.model,
            OmegaConf.create(
                self.dfl_node_agent_config.aggregator_kwargs if
                hasattr(self.dfl_node_agent_config, "aggregator_kwargs") else {}
            ),
            self.logger,
        )
