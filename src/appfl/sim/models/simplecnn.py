...
class SimpleCNN(
    torch.nn.Module
):  # for CIFAR10 experiment in McMahan et al., 2016; (https://github.com/tensorflow/tensorflow/blob/r0.11/tensorflow/models/image/cifar10/cifar10.py)
    def __init__(self, in_channels, hidden_size, num_classes):
        ...
        self.classifier = torch.nn.Sequential(
            ...
            torch.nn.Flatten(),
            torch.nn.Linear(
                in_features=self.hidden_channels * (6 * 6), out_features=384, bias=True
            ),
            torch.nn.ReLU(),
