...
def load_appfl_client_config_funcx_web(cfg: GlobusComputeConfig, config_files: List[str], dataloaders: List[str]):
    ...
    for config_file, dataloader_file in zip(config_files, dataloaders):
        ...
        client['get_data'] = src
        # add the client
        client_cfg = OmegaConf.structured(GlobusComputeClientConfig(
...
def load_appfl_server_config_funcx_web(cfg: GlobusComputeConfig, server_config: str, model_config: str, model_file: str):
...
def load_appfl_server_config_funcx_web_v2(cfg: GlobusComputeConfig, server_config: str):
    ...
    if use_hugging_face:
        print("Using hugging face models......", data['hf_model_arc'], data['hf_model_weights'])
