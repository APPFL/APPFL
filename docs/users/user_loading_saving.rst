...
To this end, one should revise the configuration file (i.e., ``src/appfl/config/config.py``).
...
To this end, one can revise the configuration file. See the followings for an example:
