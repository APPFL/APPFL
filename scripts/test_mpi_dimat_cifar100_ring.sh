#!/bin/bash
#SBATCH --job-name=dimat-c100-ring
#SBATCH --nodes=1
...
#SBATCH --output=appfl_dimat_c100_ring_%j.out
#SBATCH --error=appfl_dimat_c100_ring_%j.err
...
# ---------- Run the experiment ----------
run_experiment() {
    echo "=== Running APPFL MPI DIMAT: CIFAR-100 IID Ring ==="
